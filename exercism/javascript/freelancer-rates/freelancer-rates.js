...
/**
 * The number of hours a day the freelancer works
 *
 * @type {number}
 */
...
/**
 * The number of hours per month the freelancer bills
 *
 * @type {number}
 */
...
export function priceWithMonthlyDiscount(ratePerHour, numDays, discount) {
  ...
  const remainingDays = numDays - fullMonths * BILLABLE_DAYS_PER_MONTH;
  const remainingDaysTotal = remainingDays * dayRate(ratePerHour);
